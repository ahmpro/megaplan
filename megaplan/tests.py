...
class TestApi(unittest.TestCase):
    ...
    def test_urls(self):
        ...
        self.assertEqual(api.test._api_url, 'https://testacc.megaplan.ru/BumsCommonApiV01/testmethod.api')
        api.accept = 'text/xml'
        self.assertEqual(api.test._api_url, 'https://testacc.megaplan.ru/BumsCommonApiV01/testmethod.xml')
